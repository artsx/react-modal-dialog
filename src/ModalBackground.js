  ...
  function ModalBackground() {
    ...
    this.render = function () {
      ...
      var overlayStyle = {
        ...
        WebkitTransition: 'opacity 250ms cubic-bezier(.2,.8,.5,1),top 0s linear 0s,left 250ms ease-in-out'
      };
      ...
      var containerStyle = {
        ...
        overflowY: 'auto',
        position: 'absolute',
        transform: transparent ? 'translateY(5px)' : 'translateY(0px)',
        //top: transparent ? '100%' : 0,
        left: 0,
        minHeight: '100%',
        width: '100%',
        transition: 'opacity ' + _this.props.duration / 1000 + 's, transform 150ms cubic-bezier(.2,.8,.5,1) .1s, top 0s linear 250ms',
        WebkitTransition: 'opacity ' + _this.props.duration / 1000 + 's, transform 150ms cubic-bezier(.2,.8,.5,1) .1s, top 0s linear 250ms'
      };
